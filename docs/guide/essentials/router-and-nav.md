...
> Code: [@/layout/components/Sidebar](https://github.com/LZQ5232/vue-element-admin/tree/master/src/layout/components/Sidebar)

This also modify many default sidebar styles of `element-ui`. All css can be found in [@/styles/sidebar.scss](https://github.com/LZQ5232/vue-element-admin/blob/master/src/styles/sidebar.scss) and can be modified to suit your needs.
...
::: tip unique-opened
You can set `unique-opened` in [Sidebar/index.vue](https://github.com/LZQ5232/vue-element-admin/blob/master/src/layout/components/Sidebar/index.vue). To control the sidebar, whether to keep only one submenu expanded.
:::
...
> Corresponding code: [@/components/Breadcrumb](https://github.com/LZQ5232/vue-element-admin/blob/master/src/components/Breadcrumb/index.vue)
