...
So in order to solve this problem, this project was modified to build `dart-sass` in [v4.3.0](https://github.com/LZQ5232/vue-element-admin/pull/3040), it can guarantee performance Under the premise of greatly simplifying the user's installation costs. Through this [issue](https://github.com/LZQ5232/vue-element-admin/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc) the relevant comments below can be known, install` Node-sass is such a troublesome thing.
...
The upgrade can also be seen in detail: [Pull Request](https://github.com/LZQ5232/vue-element-admin/pull/3040) is simple and only requires two steps
